...
public class C_A58 extends AppCompatActivity {
    ...
    String Tdo_A58 = "", Temperatura = "", Humedad = "", Temp_Suministro = "", Temp_Retorno = "", Hora_Ingreso = "", Hora_Salida = "", Turno = "";
    int Ronda = 0;
            ...
            public void onClick(View v) {
                ...
                /*if (SE_SELECCIONO_VARIOS_CHILLER() == false) {
                    ...
                    for (int i = 0; i < lPasillos.getChildCount(); i++) {
                        ...
                        final TextInputLayout tilTemperatura = (TextInputLayout) ly1.getChildAt(1);
                        final TextInputLayout tilHumedad = (TextInputLayout) ly1.getChildAt(2);
                        Temperatura = tilTemperatura.getEditText().getText().toString();
                        Humedad = tilHumedad.getEditText().getText().toString();
                        A58_Pasillo a58_pasillo = new A58_Pasillo("", Tdo_Pasillo, Temperatura, Humedad, Hora_Ingreso, Hora_Salida, Tdo_Turno, String.valueOf(Ronda), "A", Id_Operador, "", getDateTime(), "");
