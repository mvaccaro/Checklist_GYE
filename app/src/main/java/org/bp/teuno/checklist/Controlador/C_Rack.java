                        ...
                        .setPositiveButton("Aceptar",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        try {
                                            DATOS.GETBD().beginTransaction();
                                            long updatedResult = DATOS.DESACTIVAR_RACK(new Rack(Tdo_Fila, ID_Rack, ID_Fila, ID_UR, Id_Cliente, Marca, Modelo, Serie, CodigoBanco, "I", Usuario_Ingresa, Id_Operador, Fecha_Ingreso, getDateTime()));
                                            if (updatedResult == -1) {
