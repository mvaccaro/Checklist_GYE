...
public class C_A56 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (Access.equals("BP")) {
            ...
            //ImageView2.setImageResource(R.drawable.hpe);
            txtMensaje.setText("Formulario FT.56");
        }
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            try {
                                                ...
                                                String cliente = "";
                                                cliente = Access.equals("BP") ? "BP" : "TE";
    ...
    public int CONSULTAR_RONDA() {
        ...
        try {
            ...
            if (Access.equals("BP")) {
                ...
                T_A56 = DATOS.CONSULTA_GENERAL_RONDA_TE(Tdo_Turno, getDate());
            }
            DATOS.GETBD().setTransactionSuccessful();
        } finally {
            DATOS.GETBD().endTransaction();
    ...
    public void CARGAR_ALERTAS() {
        ...
        try {
            DATOS.GETBD().beginTransaction();
            String cliente = "";
            cliente = Access.equals("BP") ? "%ALEBP%" : "%ALETE%";
