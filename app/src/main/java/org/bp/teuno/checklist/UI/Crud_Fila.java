...
public final class Crud_Fila {
    ...
    public Cursor CONSULTA_GENERAL_FILA() {
        ...
        String sql = String.format("SELECT * FROM %s WHERE %s=? order by 3", TABLAS.FILA, I_FILA.ESTADO);
    ...
    public Cursor CONSULTA_GENERAL_FILA_POR_CLIENTE(String CLIENTE) {
        SQLiteDatabase db = BASEDATOS.getReadableDatabase();
        String sql = String.format("SELECT * FROM %s WHERE %s=? AND %s Like ? order by 3", TABLAS.FILA, I_FILA.ESTADO, I_FILA.ID_FILA);
    ...
    public Cursor CONSULTA_GENERAL_FILA_POR_ID(String ID_FILA) {
        SQLiteDatabase db = BASEDATOS.getReadableDatabase();
        String sql = String.format("SELECT * FROM %s WHERE %s=? order by 3", TABLAS.FILA, I_FILA.ID_FILA);
