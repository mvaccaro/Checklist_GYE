    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        elvLista.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (expandableListDetail.get(
                    ...
                    if(!Tdo_Turno.equals(Tdo_Turno_1)){
                        ...
                        if (bandera == 1) {
                            ...
                            Button btnTE = (Button) customView.findViewById(R.id.btnTE);
                            ...
                            btnTE.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View arg0) {
                                    ...
                                    finish();
                                    Toast.makeText(
                                            getApplicationContext(), "Ingreso correcto al mantenimiento de Alertas para TEUNO", Toast.LENGTH_SHORT
                                    ).show();
                                }
                            });
                ...
                if (expandableListDetail.get(
                        expandableListTitle.get(groupPosition)).get(
                        childPosition).equals("2.- Formulario A.56/FT.56 - Checklist monitoreo de equipos de sala útil")) {
                    OBTENERTURNO();
                    if(!Tdo_Turno.equals(Tdo_Turno_1)){
                        Toast.makeText(
                                getApplicationContext(), "Se encuentra iniciada la sesión del turno anterior, inicie una nueva sesión antes de ingresar al formulario", Toast.LENGTH_SHORT
                        ...
                        if (bandera == 1) {
                            ...
                            btnTE.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View arg0) {
                                    ...
                                    finish();
                                    Toast.makeText(
                                            getApplicationContext(), "Ingreso correcto al formulario FT.56", Toast.LENGTH_SHORT
                                    ).show();
                                }
                            });
