...
public class C_A77 extends AppCompatActivity {
    ...
    public void DIBUJAR_FILAS_DE_PASILLOS_FRIOS_LUMINOSIDAD_EN_LAYOUT() {
        ...
        for (int i = 0; i < ListaPasilloFrio.size(); i++) {
            ...
            etLuminosidadCParams.width = 120;
