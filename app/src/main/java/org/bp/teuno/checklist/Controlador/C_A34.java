...
public class C_A34 extends AppCompatActivity {
    ...
    int Ronda = 0;
    String Tdo_Uma = "", Tdo_Ups = "", Tdo_Busway = "", Tdo_Tanque = "";
    String Tdo_Area = "", Id_Area = "", Nombre_Area = "", Tdo_Tipo_Area = "", L1 = "", L2 = "", L3 = "", Bateria = "", Voltaje = "", Corriente = "", Potencia = "";
    LinearLayout lUMA, lUPSA, lUPSB, lBUSWAY, lTANQUE;
    TextView txMensaje1, txMensaje2, txMensaje3, txMensaje4, txMensaje5;
            ...
            public void onClick(View v) {
                ...
                if (!Tdo_Turno.equals(Tdo_Turno_1)) {
                    ...
                    if (bandera == 1) {
                        ...
                        Button btnDN = (Button) customView.findViewById(R.id.btnTE);
                        TextView txtMensaje = (TextView) customView.findViewById(R.id.txtMensaje);
                        ImageButton closeButton = (ImageButton) customView.findViewById(R.id.ib_close);

                        txtMensaje.setText("Formulario A.56/FT.56 - Checklist monitoreo de equipos de sala útil");
                    ...
                    builder.setTitle("Guardar Registro")
                            ...
                            .setPositiveButton("Aceptar",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            long insertedResult1 = 0, insertedResult2 = 0, insertedResult3 = 0, insertedResult4 = 0;
    ...
    public boolean VALIDAR_DATOS_VACIOS_UMAS() {
        ...
        for (int i = 0; i < lUMA.getChildCount(); i++) {
            ...
            if (swMedicion.isChecked()) {
                ...
                if (ly.getTag().equals("ARE-72") || ly.getTag().equals("ARE-76")) {
    ...
    public void LIMPIAR_DATOS() {
        ...
        for (int i = 0; i < lUMA.getChildCount(); i++) {
            ...
            if (ly1.getTag().equals("ARE-72") || ly1.getTag().equals("ARE-76")) {
    ...
    public void DIBUJAR_FILAS_DE_UMAS_EN_LAYOUT() {
        ...
        for (int i = 0; i < ListaUma.size(); i++) {
            ...
            if (ListaUma.get(i).getID().equals("ARE-72") || ListaUma.get(i).getID().equals("ARE-76")) {
                etHumedad.setText("-");
            } else {
                etHumedad.setText("-");
            }
            ...
            swMedicion.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (((Switch) v).isChecked()) {
                        ...
                        etTemperatura.setText("");
                        if (ListaUma.get(Integer.valueOf(etHumedad.getTag().toString())).getID().equals("ARE-72") || ListaUma.get(Integer.valueOf(etHumedad.getTag().toString())).getID().equals("ARE-76")) {
                            etHumedad.setText("");
                            etHumedad.setEnabled(true);
                        } else {
                            etHumedad.setText("-");
    ...
    public void DIBUJAR_FILAS_DE_UPS_A_EN_LAYOUT() {
        ...
        for (int i = 0; i < ListaUpsA.size(); i++) {
            ...
            if (ListaUpsA.get(i).getTIPO_AREA().equals("TAR-9")) {
                ...
                etL1Params.width = 150;
                etL1.setLayoutParams(etL1Params);
                //etL1.setHint("L1");
                etL1.setText("");
                etL1.setInputType(InputType.TYPE_CLASS_NUMBER);
                etL1.setFilters(new InputFilter[]{new InputFilter.LengthFilter(2)});
                ...
                etL2Params.width = 150;
                etL2.setLayoutParams(etL2Params);
                //etL2.setHint("L2");
                etL2.setText("");
                etL2.setInputType(InputType.TYPE_CLASS_NUMBER);
                etL2.setFilters(new InputFilter[]{new InputFilter.LengthFilter(2)});
                ...
                etL3Params.width = 150;
                etL3.setLayoutParams(etL3Params);
                //etL3.setHint("L3");
                etL3.setText("");
                etL3.setInputType(InputType.TYPE_CLASS_NUMBER);
                etL3.setFilters(new InputFilter[]{new InputFilter.LengthFilter(2)});
