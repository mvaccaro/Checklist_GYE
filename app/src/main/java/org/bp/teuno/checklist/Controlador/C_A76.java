...
public class C_A76 extends AppCompatActivity {
    ...
    LinearLayout lRacks;
    TextView txMensaje;
    LayoutParams lFilasRacksParams, btnMensajeParams, etClienteParams, etRackParams, etCapacidadURParams, etUrOcupadasParams, etUrDisponiblesParams;
